<template>
  ...
  <div
    class="absolute top-0 transform -translate-x-full lg:translate-x-0 shadow-md h-screen w-64 bg-white overflow-y-scroll navbar"
  >
    <div class="flex flex-col h-full pt-8">
      <!-- logo starts -->
      <div class="flex items-center space-x-4 px-6" id="logo">
        <div class="flex items-center space-x-1">
          <span class="inline-block rounded-full bg-blue-300 h-6 w-1.5"></span>
          <span
      ...
      <div class="px-8 mt-12 pb-4 text-center">
        <div class="bg-purple-150 px-4 pt-6 pb-6 rounded-3xl">
          <div>
            <p class="text-xs text-gray-700 font-medium">Your trial ends in</p>
            <p class="text-purple-500 text-xs font-semibold mt-1.5">24 days</p>
          </div>
          <button
