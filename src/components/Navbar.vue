<template>
  ...
  >
    <div class="shadow-sm h-screen w-64 bg-white overflow-y-scroll navbar">
      <div class="flex flex-col h-full pt-8">
        <!-- logo starts -->
        <div class="flex items-center space-x-5 px-7" id="logo">
        ...
        <!-- new sprint ends here -->

        <!-- navigation starts here -->
        <ul class="flex flex-col space-y-7 list-none mt-10">
          <li class="relative cursor-pointer">
            <div class="flex items-center space-x-5 px-7 text-gray-700">
              <svg
                class="w-6 h-6"
                fill="none"
                stroke="currentColor"
          ...
          <li class="relative cursor-pointer">
            ...
            ></div>
            <div class="flex items-center space-x-5 px-7 text-purple-400">
              <svg
                class="w-6 h-6"
                fill="none"
                stroke="currentColor"
        ...
        <div class="px-7 mt-10 pb-4 text-center">
